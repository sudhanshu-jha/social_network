...
SECRET_KEY = 'django-insecure-ggc0fv^h(+%)8c*v!pu(bcy)^0*!ej$zb=gpv(05a)#_!lmqzq'
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_REFRESH_COMPROMISE_DETECTION': True,
    'SLIDING_TOKEN_REFRESH_COMPROMISE_ROTATE_REFRESH_TOKENS': False,
    'ALGORITHM': 'HS256',
